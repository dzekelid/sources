...
- name: VersaPay View Your Fund Sources
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/sources/master/_listings/versapay/api-funds-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/sources/master/_listings/versapay/api-funds-get-postman.md
x-common:
- type: x-base
